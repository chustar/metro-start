...
export default {
    ...
    templates: {
        titleFragment: util.createElement(
            '<a class="panel-item bookmark-item clickable"></a>'
        ),
        titleWrapFragment: util.createElement(
            '<div class="panel-item-wrap"></div>'
        ),
        slashFragment: util.createElement(
            '<span class="options-color panel-item clickable slash">/</span>'
        ),
    ...
    templateFunc: function (bookmark) {
        ...
        if (!bookmark.url) {
            titleWrap.firstElementChild.addEventListener(
                'click',
                this.clickBookmark.bind(
                    this,
                    bookmark,
                    titleWrap.firstElementChild
                )
            );
            titleWrap.firstElementChild.appendChild(
                this.templates.slashFragment.cloneNode(true)
            );
        }
